...
drop_row1=df.index[df['仮名遣い種別'] == '旧字旧仮名']
...
writefile='GroupDouble_list_person_newnew_newold_all_utf8.csv'
#csvファイルに書き出す
new_dataframe.to_csv('GroupDouble_list_person_newnew_newold_all_utf8.csv')
